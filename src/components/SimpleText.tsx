      ...
      {resultLanguage === "fa" ? (
        <div className={styles.resultBody}>
          <p className={styles.bodyText}>
            {fileSegments &&
              fileSegments.map((segment) => segment.text).join(" ")}
          </p>
        </div>
      ) : (
        <div className={styles.resultBody}>
          <p className={styles.bodyTextEnglish}>
            ...
            [---][---] So much [stuff] you got to [understand] For every step
            [---][---] in any walkAny town of any thought[I'll] be your guideFor
            every street of [any] [sceneAny] place you've never [beenI'll] be
            your guide [---][---][---][---]
          </p>
          <p className={styles.bodyTextEnglish}>
            [---][---] Lili, take another walk out [of] your fake world
